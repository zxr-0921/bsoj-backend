...
import com.zxr.bsoj.mapper.UserMapper;
import com.zxr.bsoj.model.dto.user.UserQueryRequest;
import com.zxr.bsoj.model.entity.User;
import com.zxr.bsoj.model.enums.UserRoleEnum;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public QueryWrapper<User> getQueryWrapper(UserQueryRequest userQueryRequest) {
        ...
        String sortOrder = userQueryRequest.getOrder();
        QueryWrapper<User> queryWrapper = new QueryWrapper<>();
